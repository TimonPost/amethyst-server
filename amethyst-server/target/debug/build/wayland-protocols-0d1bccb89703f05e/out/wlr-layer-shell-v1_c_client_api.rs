...
pub mod zwlr_layer_shell_v1 {
    ...
    pub enum Request {
        ...
        /// surface.
        GetLayerSurface {id: Proxy<super::zwlr_layer_surface_v1::ZwlrLayerSurfaceV1>, surface: Proxy<super::wl_surface::WlSurface>, output: Option<Proxy<super::wl_output::WlOutput>>, layer: Layer, namespace: String, },
    }
    ...
    impl super::MessageGroup for Request {
        ...
        fn into_raw(self, sender_id: u32) -> Message {
            match self {
                Request::GetLayerSurface { id, surface, output, layer, namespace, } => Message {
                    sender_id: sender_id,
                    opcode: 0,
                    args: vec![
                        ...
                        Argument::Str(unsafe { ::std::ffi::CString::from_vec_unchecked(namespace.into()) }),
                    ]
                },
            }
        }
        ...
        fn as_raw_c_in<F, T>(self, f: F) -> T where F: FnOnce(u32, &mut [wl_argument]) -> T {
            match self {
                Request::GetLayerSurface { id, surface, output, layer, namespace, } => {
    ...
    pub trait RequestsTrait {
        ...
        /// Clients can specify a namespace that defines the purpose of the layer
        /// surface.
        fn get_layer_surface<F>(&self, surface: &Proxy<super::wl_surface::WlSurface>, output: Option<&Proxy<super::wl_output::WlOutput>>, layer: Layer, namespace: String, implementor: F) ->Result<Proxy<super::zwlr_layer_surface_v1::ZwlrLayerSurfaceV1>, ()>
            where F: FnOnce(NewProxy<super::zwlr_layer_surface_v1::ZwlrLayerSurfaceV1>) -> Proxy<super::zwlr_layer_surface_v1::ZwlrLayerSurfaceV1>;
    }
...
pub mod zwlr_layer_surface_v1 {
    ...
    pub enum Request {
        ...
        GetPopup {popup: Proxy<super::xdg_popup::XdgPopup>, },
        ...
        fn into_raw(self, sender_id: u32) -> Message {
            match self {
                ...
                Request::SetKeyboardInteractivity { keyboard_interactivity, } => Message {
                    ...
                    opcode: 4,
                    args: vec![
                        Argument::Uint(keyboard_interactivity),
                    ]
                },
    ...
    impl RequestsTrait for Proxy<ZwlrLayerSurfaceV1> {
        ...
        fn set_exclusive_zone(&self, zone: i32) ->()
        {
            let msg = Request::SetExclusiveZone {
                zone: zone,
            };
            self.send(msg);
        }
