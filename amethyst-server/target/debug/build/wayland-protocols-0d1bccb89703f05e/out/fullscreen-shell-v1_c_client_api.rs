...
pub mod zwp_fullscreen_shell_v1 {
    ...
    impl super::MessageGroup for Request {
        ...
        fn child<Meta: ObjectMetadata>(opcode: u16, version: u32, meta: &Meta) -> Option<Object<Meta>> {
            match opcode {
                2 => Some(Object::from_interface::<super::zwp_fullscreen_shell_mode_feedback_v1::ZwpFullscreenShellModeFeedbackV1>(version, meta.child())),
                _ => None
            }
        }
        ...
        fn into_raw(self, sender_id: u32) -> Message {
            match self {
                ...
                Request::PresentSurfaceForMode { surface, output, framerate, feedback, } => Message {
                    sender_id: sender_id,
                    opcode: 2,
                    args: vec![
    ...
    pub trait RequestsTrait {
        ...
        /// size or the surface size.  In either case, the surface will fill the
        /// output.
        fn present_surface_for_mode<F>(&self, surface: &Proxy<super::wl_surface::WlSurface>, output: &Proxy<super::wl_output::WlOutput>, framerate: i32, implementor: F) ->Result<Proxy<super::zwp_fullscreen_shell_mode_feedback_v1::ZwpFullscreenShellModeFeedbackV1>, ()>
            where F: FnOnce(NewProxy<super::zwp_fullscreen_shell_mode_feedback_v1::ZwpFullscreenShellModeFeedbackV1>) -> Proxy<super::zwp_fullscreen_shell_mode_feedback_v1::ZwpFullscreenShellModeFeedbackV1>;
    }
